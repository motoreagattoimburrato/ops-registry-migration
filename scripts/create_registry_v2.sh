...
echo "$(date --utc) - [INFO]: This script will create on localhost two v2 type docker registries (registry1 to 5001 and registry2 to 5002)"
...
docker run -d -p 5001:5000 --restart=always --name registry1 -v registry1:/var/lib/registry registry:2
